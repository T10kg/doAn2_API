...
function dongbophieuxuatsantonkho() {
    var row = $('#dg_sanphampxloidongtonbokho').datagrid('getSelected');
    if (row) {
        var bien = {
            id: row.id
        }
        sendajax("dongbosanphamphieuxuatsangtonkho", bien, "dg_sanphampxloidongtonbokho");
    } else {
        thongbao("Vui lòng chọn phiếu xuất cần đồng bộ")
    }
}
function setsophieuxuatloidongbotonkho() {
    var bien = {}
    send_and_set_data_by_id("demsophieuxuatloidongbotonkho", bien, "num_px_error")
}
